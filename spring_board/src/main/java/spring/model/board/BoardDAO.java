...
public class BoardDAO {
	...
	public boolean create(BoardDTO dto, Connection con) throws Exception {
		System.out.println("BoardDAO : create method");
		boolean flag = false;
	 ...
	 * @return
	 */
	public int getTotal(Map map, Connection con) throws Exception {
		int total = 0;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	 ...
	 * @return
	 */
	public List<BoardDTO> getList(Map map, Connection con) throws Exception {
	 ...
	 * @return
	 */
	public BoardDTO read(int num, Connection con) throws Exception {
		BoardDTO dto = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	public boolean passwdCheck(int num, String passwd, Connection con) throws Exception {
		boolean flag = false;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer();
	...
	public boolean update(BoardDTO dto, Connection con) throws Exception {
		boolean flag = false;
		PreparedStatement pstmt = null;
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	public boolean checkRefnum(int num, Connection con) throws Exception {
		boolean flag = false;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer();
	 ...
	 * @return
	 */
	public BoardDTO readReply(int num, Connection con) throws Exception {
		BoardDTO dto = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer();
