		...
		<form name='frm' method='POST' enctype="multipart/form-data"
			...
			<TABLE>
				...
				<TR>
					...
					<TD class="table-bordered td"><input type="text"
						name="subject" size="30"value="${dto.subject}"></TD>
				</TR>
				<TR>
					<TH class="table-bordered th">내용</TH>
					<TD class="table-bordered td"><textarea rows="10" cols="30"
			...
			<DIV class='bottom'>
				<input type='submit' value='답변' class="button"> 
